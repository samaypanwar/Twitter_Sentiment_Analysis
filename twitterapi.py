...
class Call_Tweets:
    ...
    def getTweets(self):
        ...
        print_json=json.dumps(json_response,indent=2, sort_keys=True)
...
# %%
j=Call_Tweets(ITEMS_TO_QUERY=10,query='"PS5" lang:en',tweet_fields='created_at,entities,public_metrics',user_fields='verified')()
